...
* **assert**:
  * change status of legacy asserts (James M Snell) [#38113](https://github.com/nodejs/node/pull/38113)
* **doc**:
  * apply style for legacy status (James M Snell) [#37784](https://github.com/nodejs/node/pull/37784)
...
* **deps**:
  * V8: cherry-pick cf71540c684c (BoHong Li) [#38051](https://github.com/nodejs/node/pull/38051)
...
* **fs**:
  * add promisified readFile benchmark (Nitzan Uziely) [#37608](https://github.com/nodejs/node/pull/37608)
* **http**:
...
* **lib**:
  * create diagnostics\_channel module (Stephen Belanger) [#34895](https://github.com/nodejs/node/pull/34895)
  * implement AbortSignal.abort() (James M Snell) [#37693](https://github.com/nodejs/node/pull/37693)
* **test**:
  * update dom/abort tests (James M Snell) [#37693](https://github.com/nodejs/node/pull/37693)
* **util**:
  * add getSystemErrorMap() impl (eladkeyshawn) [#38101](https://github.com/nodejs/node/pull/38101)

### Commits

* [[`f65eadc006`](https://github.com/nodejs/node/commit/f65eadc006)] - **assert**: change status of legacy asserts (James M Snell) [#38113](https://github.com/nodejs/node/pull/38113)
...
* [[`866e3244da`](https://github.com/nodejs/node/commit/866e3244da)] - **deps**: V8: cherry-pick cf71540c684c (BoHong Li) [#38051](https://github.com/nodejs/node/pull/38051)
...
* [[`f30f9314c8`](https://github.com/nodejs/node/commit/f30f9314c8)] - **(SEMVER-MAJOR)** **lib**: initial experimental AbortController implementation (James M Snell) [#33527](https://github.com/nodejs/node/pull/33527)
...
* [[`9660a78278`](https://github.com/nodejs/node/commit/9660a78278)] - **(SEMVER-MAJOR)** **timers**: move promisified timers implementations (James M Snell) [#33950](https://github.com/nodejs/node/pull/33950)
